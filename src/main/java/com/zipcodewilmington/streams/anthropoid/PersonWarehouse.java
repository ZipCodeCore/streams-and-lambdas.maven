...
public final class PersonWarehouse implements Iterable<Person> {
    ...
    public List<String> getNames() {
        return people.stream()
                .map(Person::getName)  // map is not an actual map
    ...
    public Stream<Person> getUniquelyNamedPeople() {
        ...
        this.people
                .stream()
                .forEach(person -> {   // if namesList contains
                    if(namesList.contains(person.getName())){  // is
                        uniquelyNamedPeople.add(person);  // then add the person object
     ...
     */ // TODO
    public Stream<String> getAllAliases() {  //stream is of people objects, but the props are arrays.
        return people
                .stream()
